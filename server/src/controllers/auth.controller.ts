...
import { getCurrentUser, login, refreshToken, register } from "../services/auth.service";
...
export const getCurrentUserController = async (req: Request, res: Response) => {
  try {
    ...
    const errorMessage = error instanceof Error ? error.message : "Get current user failed";
